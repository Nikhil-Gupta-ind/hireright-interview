import IconAiAnimated from './IconAiAnimated'
      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-5.75 items-center">
          ...
          <button className={`flex items-center gap-2 px-6 py-4 rounded-full border border-[#0C0C0EA3] ${companionSpeaking ? "text-[#6466EA]" : "text-[#0C0C0EA3]"} transition`}>
            <IconAiAnimated isSpeaking={companionSpeaking} /> <span className={`text-[16px] text-[#0C0C0EA3] font-medium leading-6 select-none`}>{companion?.name}</span>
          </button>
        </div>
        <div>
